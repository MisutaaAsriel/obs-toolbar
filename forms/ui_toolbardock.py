...
public:
    ...
    void setupUi(QDockWidget *toolbarDock)
    {
        ...
        sizePolicy.setHeightForWidth(toolbarDock->sizePolicy().hasHeightForWidth());
        ...
        toolbarDock->setStyleSheet(QString::fromUtf8("#toolbarDock  {\n"
"min-width: 1280px;\n"
"max-height: 52px;\n"
"padding: 0px;\n"
"}\n"
...
"max-width: 192px;\n"
"}"));
        toolbarDock->setFeatures(QDockWidget::DockWidgetClosable|QDockWidget::DockWidgetFloatable|QDockWidget::DockWidgetMovable);
        toolbarDock->setAllowedAreas(Qt::BottomDockWidgetArea|Qt::TopDockWidgetArea);
        toolbarContents = new QWidget();
        toolbarContents->setObjectName("toolbarContents");
        sizePolicy.setHeightForWidth(toolbarContents->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy1.setHeightForWidth(toolbarDockControls->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy2.setHeightForWidth(floatButton->sizePolicy().hasHeightForWidth());
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/res/images/sources/window.svg"), QSize(), QIcon::Normal, QIcon::Off);
        floatButton->setIcon(icon);

        horizontalLayout_3->addWidget(floatButton, 0, Qt::AlignVCenter);

        Spacer_Float = new QSpacerItem(10, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        horizontalLayout_3->addItem(Spacer_Float);


        horizontalLayout->addWidget(toolbarDockControls, 0, Qt::AlignVCenter);
        ...
        sizePolicy3.setHeightForWidth(modeSwitch->sizePolicy().hasHeightForWidth());
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/res/images/sources/slideshow.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        Spacer_Filler = new QSpacerItem(46, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
        ...
        sizePolicy1.setHeightForWidth(toolbarControlFiller->sizePolicy().hasHeightForWidth());
        ...
        Spacer_Center2 = new QSpacerItem(10, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        sizePolicy4.setHeightForWidth(toolbarDisplay->sizePolicy().hasHeightForWidth());
        ...
        toolbarDisplay->setStyleSheet(QString::fromUtf8("#toolbarDisplay {\n"
"padding: 4px;\n"
"min-width: 448px;\n"
"max-width: 600px;\n"
"}\n"
...
"}"));
        ...
        PaneSpacer_Left = new QSpacerItem(10, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        sizePolicy5.setHeightForWidth(statusStreamLabel->sizePolicy().hasHeightForWidth());
        ...
        statusStreamLabel->setTextInteractionFlags(Qt::NoTextInteraction);

        horizontalLayout_2->addWidget(statusStreamLabel);

        panelColon = new QLabel(toolbarDisplay);
        panelColon->setObjectName("panelColon");
        sizePolicy1.setHeightForWidth(panelColon->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy5.setHeightForWidth(statusStreamStatus->sizePolicy().hasHeightForWidth());
        ...
        statusStreamStatus->setTextInteractionFlags(Qt::NoTextInteraction);

        horizontalLayout_2->addWidget(statusStreamStatus);

        HLine_1 = new QLabel(toolbarDisplay);
        HLine_1->setObjectName("HLine_1");
        sizePolicy1.setHeightForWidth(HLine_1->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy5.setHeightForWidth(statusRecordLabel->sizePolicy().hasHeightForWidth());
        ...
        statusRecordLabel->setTextInteractionFlags(Qt::NoTextInteraction);
        ...
        sizePolicy1.setHeightForWidth(panelColon_2->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy5.setHeightForWidth(statusRecordStatus->sizePolicy().hasHeightForWidth());
        ...
        statusRecordStatus->setTextInteractionFlags(Qt::NoTextInteraction);

        horizontalLayout_2->addWidget(statusRecordStatus);

        HLine_2 = new QLabel(toolbarDisplay);
        HLine_2->setObjectName("HLine_2");
        sizePolicy1.setHeightForWidth(HLine_2->sizePolicy().hasHeightForWidth());
        ...
        statusSceneLabel->setTextInteractionFlags(Qt::NoTextInteraction);
        ...
        sizePolicy1.setHeightForWidth(panelColon_3->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy5.setHeightForWidth(statusSceneName->sizePolicy().hasHeightForWidth());
        ...
        horizontalLayout_2->addWidget(statusSceneName, 0, Qt::AlignVCenter);

        HLine_3 = new QLabel(toolbarDisplay);
        HLine_3->setObjectName("HLine_3");
        sizePolicy1.setHeightForWidth(HLine_3->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy1.setHeightForWidth(statusCPULabel->sizePolicy().hasHeightForWidth());
        ...
        PaneSpacer_Right = new QSpacerItem(10, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        Spacer_Center = new QSpacerItem(10, 20, QSizePolicy::MinimumExpanding, QSizePolicy::Minimum);
        ...
        sizePolicy2.setHeightForWidth(virtualCamButton->sizePolicy().hasHeightForWidth());
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/res/Images/video-inactive.svg"), QSize(), QIcon::Normal, QIcon::Off);
        icon2.addFile(QString::fromUtf8(":/res/Images/video-active.svg"), QSize(), QIcon::Normal, QIcon::On);
        virtualCamButton->setIcon(icon2);
        virtualCamButton->setIconSize(QSize(20, 20));
        virtualCamButton->setCheckable(true);

        horizontalLayout->addWidget(virtualCamButton, 0, Qt::AlignVCenter);

        Spacer_VirtualCam = new QSpacerItem(10, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/res/images/recording-inactive.svg"), QSize(), QIcon::Normal, QIcon::Off);
        icon3.addFile(QString::fromUtf8(":/res/images/recording-active.svg"), QSize(), QIcon::Normal, QIcon::On);
        icon3.addFile(QString::fromUtf8(":/res/images/recording-inactive.svg"), QSize(), QIcon::Disabled, QIcon::On);
        icon3.addFile(QString::fromUtf8(":/res/images/recording-inactive.svg"), QSize(), QIcon::Active, QIcon::Off);
        icon3.addFile(QString::fromUtf8(":/res/images/recording-inactive.svg"), QSize(), QIcon::Selected, QIcon::On);
        ...
        Spacer_Live = new QSpacerItem(10, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);

        horizontalLayout->addItem(Spacer_Live);

        streamButton = new QToolButton(toolbarContents);
        streamButton->setObjectName("streamButton");
        sizePolicy3.setHeightForWidth(streamButton->sizePolicy().hasHeightForWidth());
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/res/images/streaming-inactive.svg"), QSize(), QIcon::Normal, QIcon::Off);
        icon4.addFile(QString::fromUtf8(":/res/images/streaming-active.svg"), QSize(), QIcon::Normal, QIcon::On);
        icon4.addFile(QString::fromUtf8(":/res/images/streaming-inactive.svg"), QSize(), QIcon::Disabled, QIcon::On);
        icon4.addFile(QString::fromUtf8(":/res/images/streaming-inactive.svg"), QSize(), QIcon::Selected, QIcon::On);
    ...
    {
        toolbarDock->setWindowTitle(QCoreApplication::translate("toolbarDock", "Toolbar", nullptr));
#if QT_CONFIG(tooltip)
        floatButton->setToolTip(QCoreApplication::translate("toolbarDock", "Dock/Undock", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        floatButton->setAccessibleName(QCoreApplication::translate("toolbarDock", "Dock/Undock", nullptr));
#endif // QT_CONFIG(accessibility)
        floatButton->setText(QString());
#if QT_CONFIG(tooltip)
        modeSwitch->setToolTip(QCoreApplication::translate("toolbarDock", "Basic.TogglePreviewProgramMode", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        modeSwitch->setAccessibleName(QCoreApplication::translate("toolbarDock", "Basic.TogglePreviewProgramMode", nullptr));
#endif // QT_CONFIG(accessibility)
        modeSwitch->setText(QCoreApplication::translate("toolbarDock", "Basic.TogglePreviewProgramMode", nullptr));
        toolbarControlFiller->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarSpace", nullptr)));
#if QT_CONFIG(accessibility)
        statusStreamLabel->setAccessibleName(QCoreApplication::translate("toolbarDock", "Basic.Stats.Status", nullptr));
#endif // QT_CONFIG(accessibility)
        statusStreamLabel->setText(QCoreApplication::translate("toolbarDock", "Basic.Stats.Status", nullptr));
        statusStreamLabel->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusLabel", nullptr)));
        panelColon->setText(QCoreApplication::translate("toolbarDock", ": ", nullptr));
        statusStreamStatus->setText(QCoreApplication::translate("toolbarDock", "Basic.Stats.Status.Inactive", nullptr));
        statusStreamStatus->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusText", nullptr)));
        HLine_1->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolDIsplaySeparator", nullptr)));
        statusRecordLabel->setText(QCoreApplication::translate("toolbarDock", "Basic.Stats.Output.Recording", nullptr));
        statusRecordLabel->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusLabel", nullptr)));
        statusRecordStatus->setText(QCoreApplication::translate("toolbarDock", "Basic.Stats.Status.Inactive", nullptr));
        statusRecordStatus->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusText", nullptr)));
        HLine_2->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolDIsplaySeparator", nullptr)));
        statusSceneLabel->setText(QCoreApplication::translate("toolbarDock", "Basic.Scene", nullptr));
        statusSceneLabel->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusLabel", nullptr)));
        statusSceneName->setText(QCoreApplication::translate("toolbarDock", "Basic.Scene", nullptr));
        statusSceneName->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusText", nullptr)));
        HLine_3->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolDIsplaySeparator", nullptr)));
        statusCPULabel->setText(QCoreApplication::translate("toolbarDock", "CPU: ", nullptr));
        statusCPULabel->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusLabel", nullptr)));
        statusCPUUsage->setText(QCoreApplication::translate("toolbarDock", "%", nullptr));
        statusCPUUsage->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "toolbarStatusText", nullptr)));
#if QT_CONFIG(tooltip)
        virtualCamButton->setToolTip(QCoreApplication::translate("toolbarDock", "Basic.Main.StartVirtualCam", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        virtualCamButton->setAccessibleName(QCoreApplication::translate("toolbarDock", "Basic.Main.StartVirtualCam", nullptr));
#endif // QT_CONFIG(accessibility)
        virtualCamButton->setProperty("themeID", QVariant(QCoreApplication::translate("toolbarDock", "vcamButton", nullptr)));
#if QT_CONFIG(tooltip)
        recordButton->setToolTip(QCoreApplication::translate("toolbarDock", "Basic.Main.StartRecording", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        recordButton->setAccessibleName(QCoreApplication::translate("toolbarDock", "Basic.Main.StartRecording", nullptr));
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(tooltip)
        streamButton->setToolTip(QCoreApplication::translate("toolbarDock", "Basic.Main.StartStreaming", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        streamButton->setAccessibleName(QCoreApplication::translate("toolbarDock", "Basic.Main.StartStreaming", nullptr));
#endif // QT_CONFIG(accessibility)
        streamButton->setText(QCoreApplication::translate("toolbarDock", "Basic.Main.StartStreaming", nullptr));
    } // retranslateUi
