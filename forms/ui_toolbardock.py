...
"}"));
        ...
        sizePolicy4.setHeightForWidth(toolbarControlFiller->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy5.setHeightForWidth(toolbarDisplay->sizePolicy().hasHeightForWidth());
...
"}"));
        ...
        sizePolicy6.setHeightForWidth(statusStreamLabel->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy6.setHeightForWidth(statusStreamStatus->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy6.setHeightForWidth(statusRecordLabel->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy6.setHeightForWidth(statusRecordStatus->sizePolicy().hasHeightForWidth());
        ...
        sizePolicy6.setHeightForWidth(statusSceneName->sizePolicy().hasHeightForWidth());
